...
const music = cargarSonido("/dokisecret/api/sound/music/dreams.mp3");
...
let sayori = new Character("sayori",9000,"assets/custom/sayori.png");
let natsuki = new Character("natsuki", 9000,"assets/custom/natsuki.png");
let yuri = new Character("yuri",8000,"assets/custom/yuri.png");
const pickWinner = () => {
    const scores = [
        { character: "sayori", score: sayori.score },
        { character: "natsuki", score: natsuki.score },
        { character: "yuri", score: yuri.score },
    ];
    scores.sort((a, b) => b.score - a.score);
    openNext(scores[0].character);
}
...
fetch("/dokisecret/data/poem-words.json")
    .then(res => res.json())
    .then(x => {
        let tenWords = []
...
function openNext(character){
    ...
    window.open("/dokisecret/juego.html", "_self")
}
